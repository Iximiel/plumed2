...
//in that way they are automatically declared templated without declaration+implementation
...
template<typename T> constexpr TensorGeneric<T,3,3> inverse(const TensorGeneric<T,3,3>&);
/// \ingroup TOOLBOX
/// returns the determinant of a 3x3 tensor (same as TensorGeneric<T,3,3>::determinant())
template<typename T> constexpr T determinant(const TensorGeneric<T,3,3>&);
template<typename T> constexpr TensorGeneric<T,3,3> dcrossDv1(const VectorGeneric<T,3>&,const VectorGeneric<T,3>&);
template<typename T> constexpr TensorGeneric<T,3,3> dcrossDv2(const VectorGeneric<T,3>&,const VectorGeneric<T,3>&);
template<typename T> constexpr TensorGeneric<T,3,3> VcrossTensor(const VectorGeneric<T,3>&,const TensorGeneric<T,3,3>&);
template<typename T> constexpr TensorGeneric<T,3,3> VcrossTensor(const TensorGeneric<T,3,3>&,const VectorGeneric<T,3>&);
/// \ingroup TOOLBOX
/// Derivative of a normalized vector
template<typename T> constexpr TensorGeneric<T,3,3> deriNorm(const VectorGeneric<T,3>&,const TensorGeneric<T,3,3>&);
...
/// In case a wrong number of parameters is given, a static assertion will fail.
  template<typename... Args>
  constexpr TensorGeneric(T first,Args... arg);
/// initialize the tensor to zero
  constexpr TensorGeneric();
/// initialize a tensor as an external product of two Vector
  constexpr TensorGeneric(const VectorGeneric<T,n>&v1,const VectorGeneric<T,m>&v2);
/// set it to zero
  constexpr void zero();
...
/// increment
  constexpr TensorGeneric& operator +=(const TensorGeneric& b);
/// decrement
  constexpr TensorGeneric& operator -=(const TensorGeneric& b);
/// multiply
  constexpr TensorGeneric& operator *=(T);
/// divide
  constexpr TensorGeneric& operator /=(T);
/// return +t
  constexpr TensorGeneric operator +()const;
/// return -t
  constexpr TensorGeneric operator -()const;
/// set j-th column
  constexpr TensorGeneric& setCol(unsigned j,const VectorGeneric<T,n> & c);
/// set i-th row
  constexpr TensorGeneric& setRow(unsigned i,const VectorGeneric<T,m> & r);
/// get j-th column
  constexpr VectorGeneric<T,n> getCol(unsigned j)const;
/// get i-th row
  constexpr VectorGeneric<T,m> getRow(unsigned i)const;
/// return t1+t2
  friend constexpr TensorGeneric operator+ (TensorGeneric t1,const TensorGeneric& t2) {return t1+=t2;}
/// return t1-t2
  friend constexpr TensorGeneric operator- (TensorGeneric t1,const TensorGeneric& t2) {return t1-=t2;}
/// scale the tensor by a factor s
  template<typename U>
  friend constexpr TensorGeneric operator*(TensorGeneric t1,U s) {return t1*=s;}
/// scale the tensor by a factor s
  template<typename U>
  friend constexpr TensorGeneric operator*(U s,TensorGeneric t1) {return t1*=s;}
/// scale the tensor by a factor 1/s
  template<typename U>
  friend constexpr TensorGeneric operator/(TensorGeneric t1,U s) {return t1*=(T(1.0)/s);}
/// returns the determinant
  constexpr T determinant()const;
/// return an identity tensor
  constexpr static TensorGeneric<T,n,n> identity();
/// return the matrix inverse
  constexpr TensorGeneric inverse()const;
/// return the transpose matrix
  constexpr TensorGeneric<T,m,n> transpose()const;
/// << operator.
...
template<typename T, unsigned n, unsigned m>
constexpr void TensorGeneric<T,n,m>::auxiliaryConstructor()
{}

template<typename T, unsigned n, unsigned m>
template<typename... Args>
constexpr void TensorGeneric<T,n,m>::auxiliaryConstructor(T first,Args... arg)
{
...
template<typename T, unsigned n, unsigned m>
template<typename... Args>
constexpr TensorGeneric<T,n,m>::TensorGeneric(T first,Args... arg)
{
...
template<typename T, unsigned n, unsigned m>
constexpr T* TensorGeneric<T,n,m>::data() {return d.data();}
template<typename T, unsigned n, unsigned m>
constexpr const T* TensorGeneric<T,n,m>::data() const {return d.data();}

template<typename T, unsigned n, unsigned m>
constexpr TensorGeneric<T,n,m>::TensorGeneric() {
...
template<typename T, unsigned n, unsigned m>
constexpr TensorGeneric<T,n,m>::TensorGeneric(const VectorGeneric<T,n>&v1,const VectorGeneric<T,m>&v2) {
...
template<typename T, unsigned n, unsigned m>
constexpr void TensorGeneric<T,n,m>::zero() {
  LoopUnroller<T,n*m>::_zero(d.data());
}

template<typename T, unsigned n, unsigned m>
constexpr T & TensorGeneric<T,n,m>::operator() (unsigned i,unsigned j) {
...
template<typename T, unsigned n, unsigned m>
constexpr const T & TensorGeneric<T,n,m>::operator() (unsigned i,unsigned j)const {
#ifdef _GLIBCXX_DEBUG
// index i is implicitly checked by the std::array class
  plumed_assert(j<m);
#endif
...
template<typename T, unsigned n, unsigned m>
constexpr TensorGeneric<T,n,m>& TensorGeneric<T,n,m>::operator +=(const TensorGeneric<T,n,m>& b) {
...
template<typename T, unsigned n, unsigned m>
constexpr TensorGeneric<T,n,m>& TensorGeneric<T,n,m>::operator *=(T s) {
...
template<typename T, unsigned n, unsigned m>
constexpr TensorGeneric<T,n,m> TensorGeneric<T,n,m>::operator+()const {
  return *this;
}
...
template<typename T, unsigned n, unsigned m>
constexpr TensorGeneric<T,n,m>& TensorGeneric<T,n,m>::setCol(unsigned j,const VectorGeneric<T,n> & c) {
  for(unsigned i=0; i<n; ++i) (*this)(i,j)=c(i);
  return *this;
}

template<typename T, unsigned n, unsigned m>
constexpr TensorGeneric<T,n,m>& TensorGeneric<T,n,m>::setRow(unsigned i,const VectorGeneric<T,m> & r) {
  for(unsigned j=0; j<m; ++j) (*this)(i,j)=r(j);
  return *this;
}

template<typename T, unsigned n, unsigned m>
constexpr VectorGeneric<T,n> TensorGeneric<T,n,m>::getCol(unsigned j)const {
  VectorGeneric<T,n> v;
...
template<typename T, unsigned n, unsigned m>
constexpr VectorGeneric<T,m> TensorGeneric<T,n,m>::getRow(unsigned i)const {
  VectorGeneric<T,m> v;
...
template<typename T, unsigned n, unsigned m>
inline
constexpr T TensorGeneric<T,n,m>::determinant()const {
...
template<typename T, unsigned n, unsigned m>
inline
constexpr TensorGeneric<T,n,n> TensorGeneric<T,n,m>::identity() {
...
template<typename T, unsigned n, unsigned m>
constexpr TensorGeneric<T,m,n> TensorGeneric<T,n,m>::transpose()const {
...
template<typename T, unsigned n, unsigned m>
inline
constexpr TensorGeneric<T,n,m> TensorGeneric<T,n,m>::inverse()const {
...
constexpr TensorGeneric<T,n,l> matmul(const TensorGeneric<T,n,m>&a,const TensorGeneric<T,m,l>&b) {
...
constexpr T matmul(const VectorGeneric<T,n_>&a,const VectorGeneric<T,n_>&b) {
  return dotProduct(a,b);
}

/// matrix-matrix-matrix multiplication
template<typename T, unsigned n, unsigned m, unsigned l, unsigned i>
constexpr TensorGeneric<T,n,i> matmul(const TensorGeneric<T,n,m>&a,const TensorGeneric<T,m,l>&b,const TensorGeneric<T,l,i>&c) {
...
template<typename T, unsigned n, unsigned m>
constexpr T matmul(const VectorGeneric<T,n>&a,const TensorGeneric<T,n,m>&b,const VectorGeneric<T,m>&c) {
  return matmul(matmul(a,b),c);
}

template <typename T>
inline
constexpr T determinant(const TensorGeneric<T,3,3>&t) {
  return t.determinant();
}

template <typename T>
inline
constexpr TensorGeneric<T,3,3> inverse(const TensorGeneric<T,3,3>&t) {
  return t.inverse();
}
/// returns the transpose of a tensor (same as TensorGeneric::transpose())
template<typename T, unsigned n, unsigned m>
constexpr TensorGeneric<T,n,m> transpose(const TensorGeneric<T,m,n>&t) {
  return t.transpose();
}

/// returns the transpose of a tensor (same as TensorGeneric(const VectorGeneric&,const VectorGeneric&))
template<typename T, unsigned n, unsigned m>
constexpr TensorGeneric<T,n,m> extProduct(const VectorGeneric<T,n>&v1,const VectorGeneric<T,m>&v2) {
  return TensorGeneric<T,n,m>(v1,v2);
}

template <typename T>
inline
constexpr TensorGeneric<T,3,3> dcrossDv1(const VectorGeneric<T,3>&v1,const VectorGeneric<T,3>&v2) {
...
template <typename T>
inline
constexpr TensorGeneric<T,3,3> dcrossDv2(const VectorGeneric<T,3>&v1,const VectorGeneric<T,3>&v2) {
...
template <typename T>
inline
constexpr TensorGeneric<T,3,3> VcrossTensor(const VectorGeneric<T,3>&v1,const TensorGeneric<T,3,3>&v2) {
...
template <typename T>
inline
constexpr TensorGeneric<T,3,3> VcrossTensor(const TensorGeneric<T,3,3>&v2,const VectorGeneric<T,3>&v1) {
  TensorGeneric<T,3,3> t;
  for(unsigned i=0; i<3; i++) {
    t.setRow(i,-matmul(dcrossDv2(v1,v1),v2.getRow(i)));
  }
...
template <typename T>
inline
constexpr TensorGeneric<T,3,3> deriNorm(const VectorGeneric<T,3>&v1,const TensorGeneric<T,3,3>&v2) {
