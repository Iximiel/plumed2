...
public:
  ...
  void dotestWithReference(std::ofstream &output) {
    ...
    inputTest(output, Input::justPositions(td.positions()));
    output << "*Passing only masses:\n";
    inputTest(output, Input::justMasses(td.masses()));
    output << "*Passing only charges:\n";
    inputTest(output, Input::justCharges(td.charges()));
  }
  void dotestWithConstReference(std::ofstream &output) {
    ...
    output << "*Passing only positions:\n";
    inputTest(output, Input::justPositions(td.c_positions()));
    output << "*Passing only masses:\n";
    inputTest(output, Input::justMasses(td.c_masses()));
    output << "*Passing only charges:\n";
    inputTest(output, Input::justCharges(td.c_charges()));
  }
